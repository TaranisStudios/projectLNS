...
const box_pieces = preload("res://prefabs/interactable/box_pieces.tscn")
const coin_instance = preload("res://prefabs/interactable/coin_rigid.tscn")

@onready var animation_player := $Anim as AnimationPlayer
@onready var spawn_coin := $Coin_Spawn as Marker2D
